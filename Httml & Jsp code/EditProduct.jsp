...
<body>
	...
	<%
		...
		out.println("Name &emsp;&nbsp <input class='input' type='text' name='name' value='"+pb.getpName()+"'><br>");
		out.println("<br>Company  <input class='input' type='text' name='pcom' value='"+pb.getpCompany()+"'><br>");
		out.println("<br>Price &emsp;&nbsp &nbsp  <input class='input' type='text' name='price' value='"+pb.getpPrice()+"'><br>");
